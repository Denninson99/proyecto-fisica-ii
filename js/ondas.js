...
const CASOS_ONDAS = {
  diamante: {
    ...
    resumen: 'Ejemplo 32.2: λ₀ = 589 nm, v = 1.24 × 10⁸ m/s y λ = 244 nm.'
  },
  ferrita: {
    ...
    resumen: 'Ejemplo 32.2: λ₀ = 3.33 m, v = 3.00 × 10⁶ m/s y λ = 3.33 cm.'
  },
  vacio: {
    nombre: 'Vacío / aire aproximado',
    frecuencia: 90.0e6,
    K: 1,
    Km: 1,
...
function setup() {
  ...
  uiOndas = {
    ...
    valorK: document.getElementById('valorK'),
...
function dibujarComparacionOndas(e) {
  ...
  textSize(12);
  textAlign(CENTER);
  text('Las ondas E y B están en fase. En el material se comprime la longitud de onda porque v disminuye.', width / 2, 432);
}
